...
#theorem(
  [
    Докажем свойство 3 из прошлого определения:
    $
      E = L plus.o L^perp
    $
  ],
...
#def(
  ...
  [
    ортогональной проекцией вектора $b$ на подпространство $L$ ($"pr"_L (a)$) называется вектор-проекция, ортогональный $L^perp$

    _*Определение полный бред, надо искать другое*_
  ],
)
#theorem(
  [
    Пусть $e_1, e_2, dots, e_k$ --- ОНБ $L subset.eq E$, $a in E$ --- произвольный вектор, тогда
    $
