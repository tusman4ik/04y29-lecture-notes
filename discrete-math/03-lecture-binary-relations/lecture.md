...
| Свойство            | Определение                                                          | Представление                                                                                                                                                       |
| ------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Рефлексивность      | $\forall a \in M: a~R~a$                                             | ![[Drawing 2025-10-01 23.43.16.excalidraw.png\|150]]<br>В графе обязаны быть все возможные петли.                                                                   |
| Иррефлексивность    | $\forall a \in M: a \cancel{R} a$                                    | ![[Drawing 2025-10-01 23.43.16.excalidraw 2.png\|150]]<br>В графе нет петель.                                                                                       |
| Корефлексивность    | $\forall x, y \in A: x~R~y \implies x = y$                           | ![[Drawing 2025-10-02 00.11.35.excalidraw.png\|200]]<br>Все рёбра в графе — петли.<br>                                                                              |
| Симметричность      | $\forall a, b \in M : a ~R~b \implies b~R~a$                         | ![[Drawing 2025-10-01 23.43.16.excalidraw 1.png\|200]]<br>В графе обязаны быть все кратные рёбра.                                                                   |
| Антисимметричность  | $\forall a, b \in M : a~R~b \wedge b~R~a \implies a=b$               | ![[Drawing 2025-10-02 00.05.44.excalidraw.png\|200]]<br>В графе недопустимы кратные рёбра, но допустимы петли.<br>                                                  |
| Асимметричность     | $\forall a, b \in M : a~R~b \implies b\cancel{R}a$                   | ![[Drawing 2025-10-02 00.05.44.excalidraw 1.png\|200]]<br>В графе недопустимы кратные рёбра и петли.<br><br>Асимметричность = антисимметричность + иррефлексивность |
| Транзитивность      | $\forall a, b, c \in M : a~R~b \wedge b~R~c \implies a~R~c$          | ![[Drawing 2025-10-01 23.43.16.excalidraw 1 1.png\|200]]<br>Любая тройка вершин в графе транзитивна.                                                                |
| Антитранзитивность  | $\forall a, b, c \in M : a~R~b \wedge b~R~c \implies a~\cancel{R}~c$ | ![[Drawing 2025-10-01 23.43.16.excalidraw 1 1 1.png\|200]]<br>В графе нет ни одной транзитивной тройки вершин.                                                      |
| Правая евклидовость | $\forall a, b, c \in M: (a~R~c \wedge a~R~b) \implies b~R~c$         | ![[Drawing 2025-10-02 00.14.28.excalidraw.restored.png\|200]]                                                                                                       |
| Левая евклидовость  | $\forall a, b, c \in M : (b~R~a \wedge c~R~a) \implies b~R~c$        | ![[Drawing 2025-10-02 00.14.28.excalidraw.restored 1.png\|200]]                                                                                                     |
...
> [!Info]
> **Quotient set** (*фактор-множество*) — множество всех классов эквивалентности: $$M/_{R} = \{[x]_R ~\vert~x \in M\} $$
...
> [!Info]
> **Замыканием** отношения $R$ по свойству $P$ называется минимальное надмножество $R$, удовлетворяющее свойству $P$.

> [!Important]
> **Рефлексивным** замыканием $r(R)$ отношения $R \subseteq M^2$ называется минимальное рефлексивное надмножество $R$: $$r(R) = R \cup I_M $$
> 
> ![[Drawing 2025-10-28 20.59.11.excalidraw.png|400]]
> 
> **Симметричным** замыканием $s(R)$ отношения $R \subseteq M^2$ называется минимальное симметричное надмножество $R$: $$s(R) = R \cup R^{-1}$$
> 
> ![[Drawing 2025-10-28 21.03.38.excalidraw.png|400]]
> 
> **Транзитивным** замыканием $t(R)$ отношения $R \subseteq M^2$ называется минимальное транзитивное надмножество $R$: $$t(R) = \bigcup\limits_{n = 1}^\infty R^n $$
> 
>![[Drawing 2025-10-28 21.06.38.excalidraw.png|400]]

### Алгоритм Уоршелла

Алгоритм Уоршелла заключается в построении транзитивного замыкания путём последовательного выбора элементов множества и добавления связей $\langle a, c \rangle$ таких, что на момент текущей итерации в отношении есть связи $\langle a, i \rangle$ и $\langle i, b \rangle$, где $i$ — элемент, рассматриваемый на текущей итерации.

Рассмотрим принцип действия алгоритма на примере следующего отношения: $$R = \{\langle a, b \rangle, \langle a, c \rangle, \langle b, a \rangle, \langle c, d \rangle, \langle d, b \rangle, \langle d, c \rangle \} $$
![[Drawing 2025-10-28 21.39.56.excalidraw.png]]